 ...
 */
val GAME_GRAPH = NavRoute("game", pathParams = PathParams(IN_GAME_ARG_GAME_NAME), queryParams = QueryParams(IN_GAME_ARG_GAME_ID))
/**
 * IN_GAME_ARG_GAME_NAME, IN_GAME_ARG_GAME_ID
 */
private val LOBBY_ROUTE = NavRoute(base = "lobby", pathParams = PathParams(IN_GAME_ARG_GAME_NAME), queryParams = QueryParams(IN_GAME_ARG_GAME_ID))
